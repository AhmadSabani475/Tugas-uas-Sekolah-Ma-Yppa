                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="proses-pelajaran.php" method="POST">
                                ...
                                <a href="pelajaran.php" class="btn btn-danger"><i class="fa-solid fa-xmark"></i>
                                    Batal</a>
                            </form>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <button type="button"
                                                class="btn btn-sm btn-warning rounded-0 col-10">Updating</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
