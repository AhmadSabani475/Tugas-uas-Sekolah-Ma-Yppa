...
<div id="layoutSidenav_content">
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group mb-2">
                                    <span class="input-group-text"><i
                                            class="fa-solid fa-calendar-days fa-sm"></i></span>
                                ...
                                <div class="input-group mb-2">
                                    <span class="input-group-text"><i
                                            class="fa-solid fa-location-arrow fa-sm"></i></span>
    ...
    <script>
        ...
        const averange = document.getElementById('rata2');
        ...
        function fnhitung() {
            ...
            for (let i = 0; i < nilaiUjian.length; i++) {
                ...
                averange.value = Math.round(totalNilai / listNilai.length);
            }
        }
    </script>
