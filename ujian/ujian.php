        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="nilai-ujian.php" class="btn btn-primary btn-sm float-end ms-1"><i
                            ...
                            while ($data = mysqli_fetch_array($queryUjian)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <button type="button"
                                                class="btn btn-danger btn-sm rounded-0 col-10 fw-bold text-uppercase">
                                                <?= $data['hasil_ujian'] ?>
                                            </button>
                                        <?php }
                                        ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <label class="form-control">Pilih No peserta Ujian</label>
