...
$title = "Profile Sekolah - MA YPPA Cipulus";
...
if ($msg == 'notimage') {
    ...
    <i class="fa-solid fa-triangle-exclamation"></i> updated data sekolah gagal 
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 text-center px-5">
                                ...
                                <small class="text-secondary">Pilih gambar PnG, JPG, jpeg dengan ukuran Maks 1mb</small>
                            </div>
                            <div class="col-8">
