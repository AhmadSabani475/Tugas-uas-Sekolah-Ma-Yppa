...
$title = "Ganti Password - MA YPPA CIPULUS";
...
if ($msg == 'err1') {
    ...
    <i class="fa-solid fa-circle-xmark"></i> Ganti Password gagal, konfirmasi password harus sama
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>';
}
if ($msg == 'err2') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-circle-xmark"></i> Ganti Password gagal, password lama salah
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>';
}
            ...
            <form action="proses-password.php" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-file-pen"></i> Ganti Password</span>
